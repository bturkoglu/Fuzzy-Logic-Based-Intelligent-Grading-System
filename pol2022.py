...
class Bulanik:
    def __init__(self):
        ...
        self.uzman_gorus = {
            ...
            ('zayif', 'iyi', 'iyi'): 'C',
            ('zayif', 'iyi', 'pekiyi'): 'C',
            ('zayif', 'pekiyi', 'zayif'): 'C',
            ('zayif', 'pekiyi', 'orta'): 'C',
            ('zayif', 'pekiyi', 'iyi'): 'C',
            ('zayif', 'pekiyi', 'pekiyi'): 'C',
            ('orta', 'zayif', 'zayif'): 'C',
            ('orta', 'zayif', 'orta'): 'C',
            ('orta', 'zayif', 'iyi'): 'C',
            ('orta', 'zayif', 'pekiyi'): 'C',
            ...
            ('iyi', 'pekiyi', 'iyi'): 'B',
            ('iyi', 'pekiyi', 'pekiyi'): 'B',
            ('pekiyi', 'zayif', 'zayif'): 'B',
            ('pekiyi', 'zayif', 'orta'): 'B',
            ('pekiyi', 'zayif', 'iyi'): 'B',
            ('pekiyi', 'zayif', 'pekiyi'): 'B',
            ('pekiyi', 'orta', 'zayif'): 'B',
            ('pekiyi', 'orta', 'orta'): 'B',
            ('pekiyi', 'orta', 'iyi'): 'B',
            ('pekiyi', 'orta', 'pekiyi'): 'B',
            ('pekiyi', 'iyi', 'zayif'): 'A',
            ('pekiyi', 'iyi', 'orta'): 'A',
            ('pekiyi', 'iyi', 'iyi'): 'A',
            ('pekiyi', 'iyi', 'pekiyi'): 'A',
            ('pekiyi', 'pekiyi', 'zayif'): 'A',
            ('pekiyi', 'pekiyi', 'orta'): 'A',
            ('pekiyi', 'pekiyi', 'iyi'): 'A',
            ('pekiyi', 'pekiyi', 'pekiyi'): 'A',
            }
